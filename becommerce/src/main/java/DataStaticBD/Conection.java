...
public class Conection {
    String user = "mwisklifbwraoc";
    String password = "1e423bd10b8fe409eeb7c697b329e0298f0bb9e337bccd1897273f58b06bea10";
    ...
    public boolean openConecction() {
        try {
            ...
            conex = DriverManager.getConnection("jdbc:postgresql://ec2-18-235-45-217.compute-1.amazonaws.com:5432/dcnte5im9rrpe7", user, password);
        } catch (Exception exc) {
